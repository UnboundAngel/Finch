...
export const MaxTokensSlider = ({ contrast }: MaxTokensSliderProps) => {
            ...
            return (
              <React.Fragment key={preset}>
                ...
                >
                  ...
                  <div className={cn(
                      "absolute bottom-[2px] left-1/2 -translate-x-1/2 w-3 h-[1.5px] rounded-full transition-all duration-300",
                      zone === 'emerald' ? "bg-emerald-500/30" : 
                      zone === 'amber' ? "bg-amber-500/30" : 
                      "bg-rose-500/30",
                      isSelected && "w-6 opacity-0" // Hide tick when selected
                  )} />
