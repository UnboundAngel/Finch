...
export function BookmarkIconButton({ isBookmarked, onToggle, className }: BookmarkIconButtonProps) {
  return (
    <div className={`relative flex items-center justify-center ${className}`}>
      ...
      >
        <motion.div
          ...
          whileTap={
            isBookmarked ? animations.icon.tapCompleted : animations.icon.tapActive
          }
          transition={{ type: "spring", stiffness: 300, damping: 15 }}
          className="relative flex items-center justify-center"
        >
          <Bookmark className="opacity-60" size={14} aria-hidden="true" />
