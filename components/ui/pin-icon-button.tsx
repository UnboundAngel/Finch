...
const animations = {
  icon: {
    ...
    tapActive: { scale: 0.85, rotate: -15 },
  ...
  return (
    <div className={`relative flex items-center justify-center ${className}`}>
      ...
      >
        <motion.div
          initial={{ scale: 1 }}
          animate={{ scale: isPinned ? 1.1 : 1 }}
          whileTap={
            isPinned ? animations.icon.tapCompleted : animations.icon.tapActive
          }
          transition={{ type: "spring", stiffness: 300, damping: 15 }}
          className="relative flex items-center justify-center"
        >
          <Pin className="opacity-60" size={14} aria-hidden="true" />
