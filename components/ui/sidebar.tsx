  ...
  return (
    ...
    >
      ...
      <div
        ...
        data-side={side}
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width,transform,opacity] duration-300 ease-in-out data-[side=left]:left-0 data-[side=left]:group-data-[collapsible=offcanvas]:-translate-x-[calc(var(--sidebar-width)+1.5rem)] data-[side=left]:group-data-[collapsible=offcanvas]:opacity-0 data-[side=right]:right-0 data-[side=right]:group-data-[collapsible=offcanvas]:translate-x-[calc(var(--sidebar-width)+1.5rem)] data-[side=right]:group-data-[collapsible=offcanvas]:opacity-0 md:flex",
